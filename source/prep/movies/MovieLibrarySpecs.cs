...
namespace code.prep.movies
{
   ...
   */
    ...
    public class searching_for_movies : concern_for_searching_and_sorting
    {
      ...
      {
        var criteria = Match<Movie>.with_attribute(x => x.date_published.Year).falls_in(Range.starting_at(2004));
      ...
      {
        var criteria = Match<Movie>.with_attribute(x => x.date_published.Year).falls_in(Range.starting_at(1982, true).ending_at(2003, true));
